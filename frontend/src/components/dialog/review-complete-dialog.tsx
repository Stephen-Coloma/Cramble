...
export const getReviewTally = (submittedAnswers: Record<number, MASTERY_LEVEL>) => {
  const tally = {
    mastered: 0,
    familiar: 0,
    unsure: 0,
...
const stats = getReviewTally(submittedAnswers)
  ...
  return (
    <Dialog open={showCompletionModal} onOpenChange={setShowCompletionModal}>
      <DialogContent className="sm:max-w-lg border-0 shadow-2xl bg-white/95 backdrop-blur-xl border-red-900 border-4">
        <DialogHeader>
